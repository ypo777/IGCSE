...
def showingItemsAndChooseingItems(array_one,array_two,array_three):
    for c in array_one:
        if c == "Case":
...
category_array  =       {"Case":('A1','A2'),
                         ...
                         "Solid Stat Driver":('D1','D2'),
                         "Second Hard Disk Drive":('E1','E2','E3'),
                         "Optical Driver":('F1','F2'),
...
showingItemsAndChooseingItems(category_array,itemCodeAndPrice_Array,itemCodeAndDescription_array)
outputResult()
